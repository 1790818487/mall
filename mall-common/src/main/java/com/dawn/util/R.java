...
public class R<T> {
    ...
    private R(ResponseEnum responseCode) {
        this.code = responseCode.getCode();
        this.message = responseCode.getMessage();
    }

    private R(ResponseEnum responseCode, T data) {
        this.code = responseCode.getCode();
        this.message = responseCode.getMessage();
        this.data = data;
    }
     ...
     * @return
     */
    public static<T> R<T> success(ResponseEnum responseEnum , T data) {
     ...
     * @return
     */
    public static<T> R<T> error(ResponseEnum responseCode) {
     ...
     * @return
     */
    public static<T> R<T> error(ResponseEnum responseCode, T data) {
